...
export class Tile {
     ...
     * @default
     */
    public collisionCallbackContext = this;
    ...
    constructor(public layer: object, public index: number, public x: number, public y: number, public width: number, public height: number) {

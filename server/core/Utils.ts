...
export namespace Utils {
    ...
    */
     ...
     */
    export function setProperties(obj: any, props: any) {
    ...
    export function setProperty(obj: object, name: string, value: any) {
     ...
     * @return {any} - The value of the property or `undefined` if the property isn't found.
     */
    export function _getProperty(obj: object, name: string): any {
     ...
     * @return {object} The modified object.
     */
    export function _setProperty(obj: any, name: string, value: any): any {
    ...
    */
    export function chanceRoll(chance: number): boolean {
    ...
    */
    export function randomChoice(choice1: any, choice2: any) {
    ...
    */
    export function parseDimension(size: number|string, dimension: number) {
    ...
    */
    export function pad(str: string, len: number = 0, pad: string = ' ', dir: number = 3) {

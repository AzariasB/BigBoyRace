...
*/
export class Group extends DisplayObjectContainer {

    constructor(
        public game: Game,
        parent: any = game.world,
        public name: string = 'groupe',
        public addToStage: boolean = false,
        public enableBody: boolean = false) {
            super();
    ...
    * @default
    */
    public ignoreDestroy: boolean = false;
    ...
    * @default
    */
    public updateOnlyExistingChildren: boolean = false;
    ...
    * @default
    */
    public physicsSortDirection: number = null;
    ...
    * @private
    */
    private _sortProperty: string = 'z';
    ...
    * @type {integer}
    */
    static readonly RETURN_TOTAL = 1;
    ...
    * @type {integer}
    */
    static readonly RETURN_CHILD = 2;
    ...
    * @type {integer}
    */
    static readonly SORT_DESCENDING = 1;
    ...
    */
    add(child: any, silent: boolean = false, index?: number) {
    ...
    * @return {DisplayObject} The child that was added to the group.
    */
    addAt(child: any, index: number = 0, silent: boolean = false) {
    ...
    */
    removeFromHash(child: any): boolean {
    ...
    */
    /* create(x: number, y: number, key: any, frame?: string|number, exists: boolean = true, index?: number)
    {

        if (exists === undefined) { exists = true; }

        let child = new DisplayObject(this.game, x, y, key, frame);
    ...
    /* Phaser.Group.prototype.createMultiple = function (quantity, key, frame, exists, callback, callbackContext)
    {
        ...
        key.forEach(function (singleKey)
        {
            ...
            frame.forEach(function (singleFrame)
            {
                ...
                {
                    let child = _this.create(0, 0, singleKey, singleFrame, exists);
    ...
    */
    align (width: number, height: number, cellWidth: number, cellHeight: number, position: number, offset: number): boolean {
        ...
        if (position === undefined) { position = Corner.TOP_LEFT; }
        ...
        let r = new Rectangle(0, 0, cellWidth, cellHeight);
    ...
    */
    moveUp(child) {
        ...
        if (child.parent === this && this.getIndex(child) < this.children.length - 1) {
            let a = this.getIndex(child);
            let b = this.getAt(a + 1);
    ...
    */
    replace(oldChild: any, newChild: any): any {
        ...
        let index = this.getIndex(oldChild);

        if (index !== -1) {
            if (newChild.parent) {
                if (newChild.parent instanceof Group) {
    ...
    */
    setProperty(child: any, key: any[], value: any, operation: number = 0, force: boolean = false): boolean {
    ...
    */
    checkProperty = function (child, key, value, force) {
        ...
        let result = Phaser.Utils.getProperty(child, key);
    ...
    * For example:
    *
    *     let healthyList = Group.filter(function(child, index, children) {
    ...
    */
    Phaser.Group.prototype.getFirstExists = function (exists, createIfNull, x, y, key, frame)
    {
        ...
        let child = this.getFirst('exists', exists);
    ...
    */
    Phaser.Group.prototype.getFirstAlive = function (createIfNull, x, y, key, frame)
    {
        ...
        let child = this.getFirst('alive', true);
    ...
    */
    Phaser.Group.prototype.getFirstDead = function (createIfNull, x, y, key, frame)
    {
        ...
        let child = this.getFirst('alive', false);
    ...
    */
    Phaser.Group.prototype.getRandomExists = function (startIndex, endIndex)
    {
        ...
        let list = this.getAll('exists', true, startIndex, endIndex);
    ...
    */
    Phaser.Group.prototype.remove = function (child, destroy, silent)
    {
        ...
        let removed = this.removeChild(child);
    ...
    */
    Phaser.Group.prototype.removeAll = function (destroy, silent, destroyTexture)
    {
        ...
        do
        {
            ...
            let removed = this.removeChild(this.children[0]);
    ...
    */
    Phaser.Group.prototype.removeBetween = function (startIndex, endIndex, destroy, silent)
    {
        ...
        while (i >= startIndex)
        {
            ...
            let removed = this.removeChild(this.children[i]);
    ...
    */
    Object.defineProperty(Phaser.Group.prototype, 'centerX', {
        ...
        set: function (value)
        {
            ...
            let r = this.getBounds(this.parent);
            let offset = this.x - r.x;
